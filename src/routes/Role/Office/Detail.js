...
export default class AnyClass extends React.Component {
  ...
  render() {
    ...
    const {code,name,category_id_name,department_id_name,manager_mobile,manager_name,create_time_str,create_worker_account_id_account_name,bind_treatment_flow_template_id_name} = items;
    return (
