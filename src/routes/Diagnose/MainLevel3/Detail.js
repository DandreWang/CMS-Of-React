...
export default class AnyClass extends React.Component {
  ...
  render() {
    ...
    const {loading,
      code,name,price,use_type,grand_parent_id_name='',parent_id_name='',use_type_obj={}, status,
    } = this.state;
      ...
      <PageHeaderLayout wrapperClassName={styles.wrapperClassName}>
        ...
        >
          ...
          >
            ...
            <Description className={styles.infoItem} term="所属一级诊断参数">{grand_parent_id_name||'无'}</Description>
            <Description className={styles.infoItem} term="所属二级诊断参数">{parent_id_name||'无'}</Description>
