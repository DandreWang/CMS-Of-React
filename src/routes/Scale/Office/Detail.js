...
export default class AnyClass extends React.Component {
  ...
  get_form_department_detail = () => {
    ...
    request(urls.get_form_department_detail, {
      ...
      <PageHeaderLayout wrapperClassName={styles.wrapperClassName}>
        ...
        >
          ...
          >
            ...
            {/*<Description className={styles.infoItem} term="科室分类">{category_id_name||'无'}</Description>*/}
            ...
            <Description className={styles.infoItem} term="已授权量表">{lodash.isArray(form_names)&&form_names.length?form_names.join(','):'无'}</Description>
          </DescriptionList>
