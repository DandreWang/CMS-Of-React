...
import styles from './OfficeScale.less';
...
export default class OfficeScale extends PureComponent {
            ...
            renderItem={item =>
              item ? (
                <List.Item key={item.id}>
                  <Card hoverable className={styles.card} onClick={this.toList}
                        actions={[<a onClick={this.editCard}>编辑</a>, <a onClick={() =>this.deleteCard(item.id)}>删除</a>]}>
                    <Card.Meta
