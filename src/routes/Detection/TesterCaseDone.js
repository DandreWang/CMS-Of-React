...
const filterStatusMap = {'0':'全部','1':'测评完成','2':'诊断完成','3':'治疗中','4':'治疗完成','9':'治疗中断'};
...
export default class AnyClass extends PureComponent {
    ...
    this.columns = [
      ...
      },
      {
        ...
        render: (text, record) => {
          ...
          const status = case_status-0;
          return (
            <div className="editable-row-operations">
              <Fragment>
                <a onClick={() => this.jump({ record,type:'查看报告' })}>查看报告</a>
                {
                  getAuthority()==='doctor'?(
                    <Fragment>
  ...
  componentDidMount() {
    ...
    defaultParams = {type:2,status:0,current:1,pageSize:20};
